...
// verify outputFormat
if (['default', 'csv', 'ndjson', 'silent'].indexOf(outputFormat) == -1) {
...
function hasWrk() {
  if (typeof child_process.spawnSync === 'function') {
    ...
    console.error('No spawnSync found, assuming wrk is installed ... ');
  }
}
